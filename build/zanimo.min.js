var Zanimo=function(){var g=function(a){var c=Q.defer();c.resolve(a);return c.promise};g.kDelta=100;g.when=Q.when;g.delay=function(a,c){var b=Q.defer();setTimeout(function(){b.resolve(c||a)},a);return b.promise};g.transition=function(a,c,b,d,e){var f=Q.defer(),i=-1;if(!a||!a.nodeType||!(a.nodeType>=0))return f.resolve(Q.fcall(function(){throw Error("Zanimo transition: no given dom Element!");})),f.promise;var h,j=function(){h&&(clearTimeout(h),h=null);f.resolve(a);a.removeEventListener(Zanimo.utils.prefix.evt,
j,!1)};a.addEventListener(Zanimo.utils.prefix.evt,j,!1);h=setTimeout(function(){f.reject(Error("Zanimo transition: "+a.id+" with "+c+":"+b))},d+g.kDelta);i=Zanimo.utils.addTransition(a,c);Zanimo.utils.setAttributeAt(a,"TransitionDuration",d+"ms",i);Zanimo.utils.setAttributeAt(a,"TransitionTimingFunction",e||"linear",i);Zanimo.utils.setProperty(a,c,b);return f.promise};return g}();
