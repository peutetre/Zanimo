var Zanimo=function(){var j=function(a){var f=Zanimo.async.defer();f.resolve(a);return f.promise};j.delay=function(a,f){var b=Zanimo.async.defer();setTimeout(function(){b.resolve(f||a)},a);return b.promise};j.transition=function(a,f,b,d,c){var e=Zanimo.async.defer(),g=-1,i=!1;if(!a||!a.nodeType||!(a.nodeType>=0))return e.resolve(Zanimo.async.reject("Zanimo transition Error : no given dom Element!")),e.promise;var h=function(){i=!0;e.resolve(a);a.removeEventListener(Zanimo.utils.prefix.evt,h,!1)};
a.addEventListener(Zanimo.utils.prefix.evt,h,!1);Zanimo.delay(d+20).then(function(){i||e.resolve(Zanimo.async.reject("Zanimo transition Error on "+a.id+" with "+f+":"+b))});g=Zanimo.utils.addTransition(a,f);Zanimo.utils.setAttributeAt(a,"TransitionDuration",d+"ms",g);Zanimo.utils.setAttributeAt(a,"TransitionTimingFunction",c||"linear",g);Zanimo.utils.setProperty(a,f,b);return e.promise};return j}();
