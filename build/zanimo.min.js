...
f);Zanimo.utils._setAttributeAt(a,"TransitionDuration",d+"ms",g);Zanimo.utils._setAttributeAt(a,"TransitionTimingFunction",c||"linear",g);a.style[Zanimo.utils._getAttrName(f)]=b;return e.promise};return j}();
...
(function(j,a,f){a.prefixed=["transform"];a.prefix={webkit:{evt:"webkitTransitionEnd",name:"webkit",css:"-webkit-"},opera:{evt:"oTransitionEnd",name:"O",css:"-o-"},firefox:{evt:"transitionend",name:"Moz",css:"-moz-"}};a.browser=f.match(/.*(Chrome|Safari).*/)?"webkit":f.match(/.*Firefox.*/)?"firefox":navigator.appName==="Opera"?"opera":void 0;a.prefix=a.prefix[a.browser];a.transitionProperty=a.prefix.name+"TransitionProperty";a._appendToProperty=function(a,d,c){var e=a.style[d]||"";a.style[d]=e.length>
0?e+", "+c:c;return a.style[d].split(", ").indexOf(c)};a._addTransition=function(b,d,c,e){d=a._prefixCSSAttribute(d);c=b.style[a.transitionProperty];e=(c?c.split(", "):[]).indexOf(d);return e===-1?a._appendToProperty(b,"TransitionProperty",d):e};a._setAttributeAt=function(b,d,c,e){var f=(b.style[a.prefix.name+d]||"").split(",");f[e]=c;b.style[a.prefix.name+d]=f.toString()};a._prefixCSSAttribute=function(b){return a.prefixed.indexOf(b)===-1?b:a.prefix+b};a._getAttrName=function(b){b=a.prefixed.indexOf(b)===
-1?b:a.prefix.name+"-"+b;return b.split("-").reduce(function(a,b){return a+b.charAt(0).toUpperCase()+b.substr(1)})}})(window.Zanimo,window.Zanimo.utils=window.Zanimo.utils||{},navigator.userAgent);
