...
b){return b!==g});a.style[b.transition]=d.toString()};j.kDelta=140;j.transition=function(a,d,c,f,e){var g=Q.defer(),h,i=function(){h&&(clearTimeout(h),h=null);l(a,d,c,f,e);a.removeEventListener(b.transitionend,i,!1);g.resolve(a)};if(!a||!a.nodeType||!(a.nodeType>=0))return g.reject(Error("Zanimo transition: no given dom Element!")),g.promise;a.addEventListener(b.transitionend,i,!1);window.requestAnimationFrame(function(){k(a,d,c,f,e);h=setTimeout(function(){g.reject(Error("Zanimo transition: "+a.id+
" with "+d+":"+c))},f+j.kDelta)},a);return g.promise};j.transition\u0192=function(a,b,c,f){return function(e){return j.transition(e,a,b,c,f)}};return j}();
