...
1):a).replace(/\-([a-z])/g,function(a,b){return b.toUpperCase()})};"WebkitTransition"in a.body.style&&(d="webkitTransitionEnd",c="webkit");for(var h in b)b[h]=c?c+"-"+b[h]:b[h];for(var j in e)e[j]=c?c+e[j]:e[j].charAt(0).toLowerCase()+e[j].slice(1);return{transition:g(c?c+"-transition":"transition"),transitionend:d,properties:e,norm:g,prefixProperty:function(a){return b[a]?b[a]:a}}}(window.document),i=function(a){return Q.fcall(function(){return a})},k=function(a,d,c,f,e){d=b.prefixProperty(d);a.style[b.properties.property]?
...
b){return b!==g});a.style[b.transition]=d.toString()};i.kDelta=140;i.transition=function(a,d,c,f,e){var g=Q.defer(),h,j=function(){h&&(clearTimeout(h),h=null);l(a,d,c,f,e);a.removeEventListener(b.transitionend,j,!1);g.resolve(a)};if(!a||!a.nodeType||!(a.nodeType>=0))return g.reject(Error("Zanimo transition: no DOM element!")),g.promise;a.addEventListener(b.transitionend,j,!1);window.requestAnimationFrame(function(){k(a,d,c,f,e);h=setTimeout(function(){g.reject(Error("Zanimo transition: "+a.id+" with "+
d+":"+c))},f+i.kDelta)},a);return g.promise};i.transition\u0192=function(a,b,c,f){return function(e){return i.transition(e,a,b,c,f)}};i.\u0192=function(a){return function(){return i(a)}};return i}();
